...
function EchoPage() {
    ...
    const confirmEcho = async () => await echo(amount)
    ...
    return (
        <div className="max-w-md mx-auto mt-[90px] text-white">
            <FormHead title="Echo Coins" onBack={() => navigate('/')} />
            <div className="space-y-4">
                <InputNumbers
                    id="echoAmount"
                    ref={amountRef}
                    labelComponent={<span className="text-white">Amount to Echo</span>}
                    minLimit={1}
                    onChange={setAmount}
                    placeholder="0"
                />
            ...
            <ConfirmTxModal
                ...
                tx={{ title: 'Echo Coins', amount }}
                onConfirm={confirmEcho}
