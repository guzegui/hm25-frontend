            ...
            <div className="p-5">
                ...
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex items-center gap-2 flex-1">
                        ...
                        <span className="text-gray-400 text-xs whitespace-nowrap">{project.progress}%</span>
                    </div>
                </div>
                ...
                <div className="mb-4">
                    <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-gray-400 text-xs">{completedTiers} of {totalTiers}</span>
                    </div>
                    <div className="h-4 w-full bg-gray-600 rounded-md overflow-hidden flex">
                        {project.tiers.map((tier, index) => (
                            <div 
                                key={index}
                                className={`h-full ${tier.status === "Completed" ? "bg-green-500" : tier.status === "In Progress" ? "bg-blue-500" : "bg-gray-700"} 
                ...
                {/* Next Milestone */}
                <div className="mb-4">
                    <h4 className="text-sm font-semibold text-gray-300 mb-1">Next Milestone:</h4>
